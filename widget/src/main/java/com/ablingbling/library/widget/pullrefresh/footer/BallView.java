...
public class BallView extends View {
    ...
    public static final int DEFAULT_SIZE = 35;//dp
    ...
    private void initData() {
        circleSpacing = DensityUtil.dp2px(5);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(resolveSize(DensityUtil.dp2px(DEFAULT_SIZE), widthMeasureSpec),
                resolveSize(DensityUtil.dp2px(DEFAULT_SIZE), heightMeasureSpec));
    }
