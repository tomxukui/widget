package com.ablingbling.library.widget.pullrefresh.header;
...
import com.ablingbling.library.widget.pullrefresh.internal.MaterialProgressDrawable;
...
public class MaterialHeader extends ViewGroup implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mShowBezierWave = ta.getBoolean(R.styleable.MaterialHeader_mh_ShowBezierWave, mShowBezierWave);
        mBezierPaint.setColor(ta.getColor(R.styleable.MaterialHeader_mh_PrimaryColor, 0xff11bbff));
        if (ta.hasValue(R.styleable.MaterialHeader_mh_ShadowRadius)) {
            int radius = ta.getDimensionPixelOffset(R.styleable.MaterialHeader_mh_ShadowRadius, 0);
            int color = ta.getColor(R.styleable.MaterialHeader_mh_ShadowColor, 0xff000000);
...
//                resolveSize(getSuggestedMinimumHeight(), heightMeasureSpec));
    ...
    public MaterialHeader setHeaderBackgroundColor(int backgroundColor) {
